...
//    CONTROLS controls;
    ...
    ******************************/
    ...
    public void onFinishDialogDoModify(int _position,String _tag,String _userName,String _password,String _ip,String _port,String _keyword){
        int arrnum = Integer.parseInt(arrList.get(DATA.COLNUM * _position + DATA.ARRNUM));

        int cnt = dbhelper.update(arrnum, _tag, _userName, _ip, _port, _password, _keyword);
        if (cnt == -2) {
...
//                alertDialog.cancel();
    ...
    public void onTouchListView(int _position,String _tag,String _userName,String _password,String _ip,String _port,String _keyword,String _returnValue){
        showDialogForView( _position , _tag, _userName, _password, _ip, _port, _keyword,_returnValue);
    }

    public void onFinishDialogDoAdd(String _tag,String _userName,String _password,String _ip,String _port,String _keyword){
        long cnt = dbhelper.insert(_tag,_userName,_ip,_port,_password,_keyword);
        if(cnt < 0){
...
//            Toast.makeText(getApplicationContext(), "adding_mainAct ", Toast.LENGTH_LONG).show();
    ...
    void showDialogForAdd(){
        ...
        MyAlertDialog newFragment = MyAlertDialog.newInstance(0,dbhelper,adapter,mlv,arrList,DIALOG_TYPE_ADD,null,null,null,null,null,null,null);
        newFragment.show(ft, "dialog");

    }
    void showDialogForView(int _position,String _tag,String _userName,String _password,String _ip,String _port,String _keyword,String _returnValue){
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        Fragment prev = getSupportFragmentManager().findFragmentByTag("dialog");
        if (prev != null) {
            ft.remove(prev);
        ...
        // Create and show the dialog.
        MyAlertDialog newFragment = MyAlertDialog.newInstance(_position,dbhelper,adapter,mlv,arrList,DIALOG_TYPE_SHOW,_tag, _userName, _password, _ip, _port, _keyword,_returnValue);
        newFragment.show(ft, "dialog");
    }
